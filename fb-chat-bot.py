...
class ChatBot(Client):
    ...
    def send_love_messages(self, thread_id, thread_type):
        ...
        for i in range(num_love_messages):
            ...
            time.sleep(2)  # Delay for 1 second to avoid spam detection  # Delay for 1 second to avoid spam detection  # Delay for 1 second to avoid spam detection
...
if __name__ == "__main__":
    ...
    client.send_love_messages("100078091599972", ThreadType.USER)  # Replace "TARGET_THREAD_ID" with the ID of the target thread 
